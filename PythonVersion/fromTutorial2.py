...
NumCountours = 170
BaseCanny1 = 6000#30
BaseCanny2 = 15000#265

def findBoard(image, canny1, canny2):
    global Precision, NumCountours
    ...
    gray = cv2.bilateralFilter(gray, 11, 17, 17) # cv2.GaussianBlur(gray, (7, 7), 0) <-- could help ease jumping
    ...
    # show contours for debugging - todo move to the loop
...
while True:
    ...
    # process data
    canny1, canny2 = setCanny(image)
    contours, resizeRatio, annotatedImg, edges = findBoard(image, canny1, canny2)
